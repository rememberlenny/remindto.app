class ServiceController < ApplicationController
  ...
  def oembed
    ...
    if url.split(host + '/f/').count == 0
        ...
        response[:provider_url] = "https:\/\/remindtoapp.com"
        response[:author_name] = email
        response[:author_url] = author_url
        response[:title] = title
        response[:html] = "<iframe scrolling=\"no\" width=\"800\" height=\"350\" style=\"border:none!important;width:100%!important;height:350px;\" src=\"https:\/\/remindtoapp.com\/f\/"+uuid+"?as_embed=true\"><\/iframe>"
        response[:height] = 480
        response[:width] = 800
        response[:type] = "rich"
        response[:thumbnail_url] = "https:\/\/remindtoapp.com\/form.png"
